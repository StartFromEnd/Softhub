        ...
        return(
            <div>
                ...
                <section className='container mt-3rem mb-3rem'>
                    ...
                    <p className='half'>{(this.state.faq.length <= 0 || this.state.answer.length <= 0 ||this.state.faq.faq_process !== '답변완료') ? 요청 처리중입니다 : common.UTCChangeLocal(this.state.answer[0].answer_updated_at)}</p>
                </section>
            </div>
        )
    }
