...
function Renderflexitems({index, total, link, image, title, writer, price, percent}){
    return(
        <div className='flex-items'>
            <NavLink to={{pathname:link, aboutProps:{totalData: total, percentage: percent}}} className='none-style-link'>
                ...
                <p className='bold half'>{`${Number(price).toLocaleString('ko-KR')}원`}</p>
